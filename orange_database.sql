...
--
-- Host: localhost:3306
-- Generation Time: Oct 03, 2025 at 12:19 PM
...
(1, 'admin', 'admin@123!@#', 1, '2025-10-03 06:42:57', '2025-10-03 06:42:57'),
(3, 'tester', 'tester@123', 0, '2025-10-03 06:42:57', '2025-10-03 06:42:57');
...
CREATE TABLE `appdata` (
  `id` int NOT NULL,
  `app_name` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `include_fake_user_in_matching` int NOT NULL DEFAULT '1' COMMENT '0 = Not Include | 1 = Include',
  `stream_and_gift_commission` int DEFAULT NULL COMMENT 'In Percentage',
...
INSERT INTO `appdata` (`id`, `app_name`, `currency`, `new_user_free_coins`, `min_threshold`, `coin_rate`, `min_user_live`, `max_minute_live`, `message_price`, `reverse_swipe_price`, `live_watching_price`, `admob_int_ios`, `admob_banner_ios`, `admob_int`, `admob_banner`, `is_dating`, `is_social_media`, `post_description_limit`, `post_upload_image_limit`, `include_fake_user_in_matching`, `stream_and_gift_commission`, `play_store_download_link`, `app_store_download_link`, `uri_scheme`, `created_at`, `updated_at`) VALUES
(1, 'Orange', '$', 250, 5000, '0.006', 55, 50, 5, 6, 5, 'ca-app-pub-3940256099942544/4411468910-', 'ca-app-pub-3940256099942544/2435281174', 'ca-app-pub-3940256099942544/1033173712-', 'ca-app-pub-3940256099942544/6300978111-', 1, 1, 200, 4, 0, 10, NULL, NULL, NULL, '2024-06-13 11:29:27', '2025-08-13 00:37:57');
...
CREATE TABLE `users` (
  ...
  `savedprofile` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `likedprofile` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `is_verified` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 = No | 1 = Pending | 2 = Verified | 3 = Subscription',
  ...
  `gender_preferred` int DEFAULT NULL COMMENT '1 = Male / 2 = Female / 3 = Both',
  `age_preferred_min` int DEFAULT NULL,
  `age_preferred_max` int DEFAULT NULL,
  `distance_preference` int NOT NULL DEFAULT '100',
  `relationship_goal_id` int DEFAULT NULL,
  `religion_key` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `language_keys` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dob` date DEFAULT NULL,
  `hidden_user_ids` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `app_language` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'en',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `verification_request` (
  `id` int NOT NULL,
  `user_id` int NOT NULL,
  `document` varchar(555) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `document_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `selfie` varchar(555) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fullname` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
